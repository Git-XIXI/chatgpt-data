package com.chatgpt.data.domain.weixin.service.message;
...
public class WeiXinBehaviorService implements IWeiXinBehaviorService {
    ...
    /**
     * 1. 用户的请求行文，分为事件event、消息text，这里我们只处理消息内容<br/>
    ...
    public String acceptUserBehavior(UserBehaviorMessageEntity userBehaviorMessageEntity) {
        ...
        throw new ChatGLMException(userBehaviorMessageEntity.getMsgType() + " 未被处理的行为类型 Err！");
    }
